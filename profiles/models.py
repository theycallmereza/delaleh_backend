...
class TelegramProfile(BaseModel):
    ...
    user = models.OneToOneField(
        User, on_delete=models.CASCADE, help_text="The user associated with this Telegram profile."
    )
    telegram_id = models.CharField(
        unique=True, max_length=127, help_text="The unique Telegram ID of the user, used for interacting with the bot."
    )
